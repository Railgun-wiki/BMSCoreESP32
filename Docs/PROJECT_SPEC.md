...
### 4.2 SPI (ST7789 + DAC8562, 共享 HSPI/SPI2)
| 信号 | GPIO | 备注 |
|------|------|------|
| MOSI | 11 | 共享 |
| SCLK | 12 | 共享 |
...
### Phase 1: 基础框架
- [ ] 自定义板定义 (N16R8)
- [ ] platformio.ini + lv_conf.h
- [ ] middleware submodule: LVGL (新建 dev-esp32/v9.5) + FreeRTOS
- [ ] UI submodule: lv_bms_view (新建 dev-esp32 + sparse checkout)
- [ ] BSP 驱动移植 (INA226, ST7789, DAC8562)
- [ ] LVGL 显示初始化

### Phase 2: BMS UI + 业务逻辑
- [ ] App 业务逻辑移植 (app.cpp)
- [ ] bms_hw.cpp 适配 (Wire/SPI handle)
- [ ] 4 页面 UI 渲染
